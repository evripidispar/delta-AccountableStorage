...
_CHALLENGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='testIndices', full_name='Challenge.testIndices', index=1,
